...
<div class="form-group">
    <label class="control-label col-md-1 col-sm-1 col-xs-1" for="last-name">Incidencias
    </label>
...
<div class="form-group">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <textarea id="descripcion" class="md-textarea form-control" rows="3" required="required"></textarea>
    </div>
</div>
