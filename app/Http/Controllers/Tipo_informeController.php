...
class Tipo_informeController extends AppBaseController
{
    ...
    {
        return view('admin.tipo_informes.create');
    }
    ...
    public function store(CreateTipo_informeRequest $request)
    {
        ...
        Flash::success('Tipo Informe saved successfully.');
    ...
    public function edit($id)
    {
        ...
        return view('admin.tipo_informes.edit')->with('tipoInforme', $tipoInforme);
    }
    ...
    public function update($id, UpdateTipo_informeRequest $request)
    {
        ...
        Flash::success('Tipo Informe updated successfully.');
    ...
    public function destroy($id)
    {
        ...
        $this->tipoInformeRepository->delete($id);

        Flash::success('Tipo Informe deleted successfully.');
